...
=== ASDM receive IPCP messages

image:image/vlan2.png[image,600,600,role="center"]

=== ASDM send IPCP messages

image:image/vlan3.png[image,600,600,role="center"]

=== ASDM receive IPLM messages

image:image/vlan5.png[image,600,600,role="center"]

=== ASDM send IPLM messages

image:image/vlan6.png[image,600,600,role="center"]

=== Regular communication

image:image/vlan7.png[image,600,600,role="center"]
